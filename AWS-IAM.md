...
![choose-IAM-service-screenshot](./assets/choose-IAM-service.png)

### Creating the user
From the IAM Dashboard side panel:<br>
![IAM-sidebar-screenshot](./assets/IAM-sidebar.png)<br>
Click on **Users**
...
![create-user-screenshot](./assets/create-user.png)<br>
Autogenerated password:  `<check>`<br>
User must create a new password at next sign-in:  `<check>`
![user-password-screenshot](./assets/user-password.png)<br>
...
![JSON-editor-screenshot](./assets/JSON-editor.png)<br>
...
![MFA-device-setup-screenshot](./assets/MFA-device-setup.png)<br>
Click **Add MFA**
...
![create-role-screenshot](./assets/create-role.png)<br>
Trusted entity type: **AWS account**<br>
![trusted-entity-type-screenshot](./assets/trusted-entity-type.png)<br>
An AWS account:  **This account**  |  **Require MFA**<br>
![an-AWS-account-screenshot](./assets/an-AWS-account.png)<br>
...
![add-permissions-screenshot](./assets/add-permissions.png)<br>
...
![role-details-screenshot](./assets/role-details.png)<br>
Select trusted entities:  here you can edit the policy to allow the user to assume the role.<br>
![select-role-screenshot](./assets/select-role.png)<br>
Click **Create Role**
...
![switch-roles-page-screenshot](./assets/switch-roles-page.png)<br>
Click **Switch Role**
